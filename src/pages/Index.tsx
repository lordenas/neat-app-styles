  ...
  return (
    ...
    >
      ...
      >
        ...
        <p
          className="text-xl font-bold tracking-tight mt-0.5 tabular-nums transition-opacity duration-300"
          style={{ color: cycle.color, opacity: isAnimating ? 0 : 1, minHeight: "1.75rem" }}
        >
  ...
  return (
    ...
    >
      ...
      <div className="shrink-0">
        <span className="text-xs font-semibold text-success bg-success/10 px-2 py-1 rounded-lg">+20%</span>
      </div>
    </div>
  );
});
