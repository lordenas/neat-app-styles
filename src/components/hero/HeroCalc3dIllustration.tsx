    ...
    >
      ...
      >
        ...
        >
          ...
          />
          {/* Pages stack — нейтральный серый, видимый в обоих темах */}
          {[6, 4, 2].map((offset) => (
            <div
              key={offset}
          ...
          {/* Top page — заметно светлее стопки, видно линии */}
          <div
            className="absolute inset-0 rounded-r-xl rounded-l-md overflow-hidden"
            style={{
              background: "hsl(220 15% 22%)",
              border: "1.5px solid hsl(220 15% 34%)",
              boxShadow: "0 8px 28px hsl(0 0% 0% / 0.35), inset 0 1px 0 hsl(220 15% 38%)",
            }}
          >
